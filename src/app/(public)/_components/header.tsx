    ...
    <header className="sticky top-0 z-50 bg-background/70 border-b border-accent backdrop-blur-lg text-foreground">
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center md:gap-x-3   gap-1">
          <Image src={"/assets/LOGO-HME.png"} alt="Logo" width={40} height={40} className="object-cover" />
          <Image src={"/assets/Logo-JTE-Color-New.png"} alt="Logo" width={40} height={40} className="object-cover" />
