      ...
      <section className="py-16">
        <div className="min-h-64 px-6 flex flex-col md:flex-row gap-x-44 gap-y-10 items-center justify-between">
          <div className="md:w-1/2">
            <h3 className="text-5xl font-bold">Profil</h3>
            <p className="text-muted-foreground">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur sint inventore nesciunt voluptate laudantium accusantium maxime praesentium culpa adipisci fugit.</p>
          </div>
