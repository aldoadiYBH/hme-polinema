...
export default function ProkerTable() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.error("Failed to fetch program kerja:", err)
            } finally {
                setLoading(false)
            }
        }
                        ...
                        >
                            <TableCell className="font-medium">
                                <div className="flex flex-col">
                                    <Link href={`/program-kerja/${item.slug}`} className="hover:underline">
                                        {item.title}
                                    </Link>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            <DropdownMenuItem asChild className="cursor-pointer">
                                                <Link href={`/dashboard/program-kerja/edit/${item.slug}`}>Edit</Link>
                                            </DropdownMenuItem>
                                            <DropdownMenuItem onClick={() => handleDelete(item.id)} className="cursor-pointer">
                                                Hapus
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
